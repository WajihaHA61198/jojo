  ...
  (t.prototype.needsClick = function (t) {
    ...
    (t.prototype.onTouchEnd = function (t) {
      ...
      if (
        ...
        r &&
          ...
          ((u =
            document.elementFromPoint(l.pageX - window.pageXOffset, l.pageY - window.pageYOffset) ||
        ...
        return t.timeStamp - a > 100 || (o && window.top !== window && 'input' === c)
          ...
          : (this.focus(u),
            ...
            !1);
      return (
        !(!o || i || !(s = u.fastClickScrollParent) || s.fastClickLastScrollTop === s.scrollTop) ||
    ...
    (t.prototype.onClick = function (t) {
      ...
      return this.trackingClick
        ...
        : ('submit' === t.target.type && 0 === t.detail) || ((e = this.onMouse(t)) || (this.targetElement = null), e);
    }),
    ...
    (t.notNeeded = function (t) {
      ...
      if (
        a &&
        (i = navigator.userAgent.match(/Version\/([0-9]*)\.([0-9]*)/))[1] >= 10 &&
        i[2] >= 3 &&
