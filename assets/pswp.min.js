!(function (e, t) {
  ...
  return function (e, t, n, o) {
      ...
      detectFeatures: function () {
        ...
        if (
          ...
          var r = o.match(/Android\s([0-9\.]*)/),
            l = r ? r[1] : 0;
          (l = parseFloat(l)) >= 1 && (l < 4.4 && (n.isOldAndroid = !0), (n.androidVersion = l)),
            (n.isMobileOpera = /opera mini|opera mobi/i.test(o));
        }
        for (
          var s, u, c = ['transform', 'perspective', 'animationName'], d = ['', 'webkit', 'Moz', 'ms', 'O'], p = 0;
          p < 4;
          p++
        ) {
          t = d[p];
    ...
    var l,
      ...
      De = function (e, t, n, o, i) {
        (!xe || (i && i !== a.currItem)) && (o /= i ? i.fitRatio : a.currItem.fitRatio),
          (e[D] = y + t + 'px, ' + n + 'px' + w + ' scale(' + o + ')');
      },
      ke = function (e) {
        te &&
          (e &&
            (v > a.currItem.fitRatio ? xe || (jt(a.currItem, !1, !0), (xe = !0)) : xe && (jt(a.currItem), (xe = !1))),
          De(te, de.x, de.y, v));
      },
      Me = function (e) {
      ...
      Ze = function () {
        Pe &&
          (i.unbind(document, 'mousemove', Ze), i.addClass(e, 'pswp--has_mouse'), (r.mouseUsed = !0), Ee('mouseUsed')),
      ...
      Ke = function (e, t, n, o) {
        return o === a.currItem.initialZoomLevel
          ...
          : ((n[e] = Ae(e, o)), n[e] > t.min[e] ? ((n[e] = t.min[e]), !0) : n[e] < t.max[e] && ((n[e] = t.max[e]), !0));
      },
      Be = function (e) {
        var t = '';
      ...
      $e = {
        ...
        init: function () {
          if (!l && !s) {
            ...
            for (
              (Z.animationName && Z.transform && !o) || (r.showAnimationDuration = r.hideAnimationDuration = 0), n = 0;
              n < ye.length;
              n++
            )
              a['init' + ye[n]]();
            t && (a.ui = new t(a, i)).init(),
              ...
              r.modal &&
                (ge
                  ...
                  : ((e.style.position = 'absolute'), (e.style.top = i.getScrollY() + 'px'))),
        ...
        updateSize: function (t) {
          ...
          (g = v = a.currItem.initialZoomLevel),
            (ee = a.currItem.bounds) && ((de.x = ee.center.x), (de.y = ee.center.y), ke(!0)),
            Ee('resize');
        },
        zoomTo: function (e, t, n, o, a) {
          ...
          var d = function (t) {
            1 === t
              ...
              : ((v = (e - s) * t + s), (de.x = (l.x - u) * t + u), (de.y = (l.y - c) * t + c)),
              a && a(t),
              ke(1 === t);
          };
      ...
      Et = function (e) {
        ...
        return (
          k
            ...
            ? e.touches &&
              e.touches.length > 0 &&
              ((It[0] = wt(e.touches[0], Ct)), e.touches.length > 1 && (It[1] = wt(e.touches[1], Tt)))
      ...
      At = function (e, t) {
        ...
        return (
          n || p > ct.x == t.lastFlickSpeed.x > 0
            ? ((d = Math.abs(t.lastFlickSpeed.x) > 0 ? m / Math.abs(t.lastFlickSpeed.x) : 333),
              (d = Math.min(d, 400)),
              (d = Math.max(d, 250)))
            : (d = 333),
          lt === c && (n = !1),
    ...
    var Pt,
      ...
      Bt = function (t, n, o, l) {
        ...
        !(function () {
          ...
          t.miniImg && (t.miniImg.style.webkitBackfaceVisibility = 'hidden'),
            o ||
              ((v = s.w / t.w), (de.x = s.x), (de.y = s.y - R), (a[l ? 'template' : 'bg'].style.opacity = 0.001), ke()),
            Ve('initialZoom'),
      ...
      Yt = function (e, t, n) {
        if (e.src && !e.loadError) {
          var o = !n;
          if (
            (o && (e.vGap || (e.vGap = { top: 0, bottom: 0 }), Ee('parseVerticalMargin', e)),
            (Ht.x = t.x),
      ...
      Xt = function (e, t) {
        if (e.src && e.loadError && e.container)
          return t && (e.container.innerHTML = ''), (e.container.innerHTML = r.errorMsg.replace('%url%', e.src)), !0;
      },
      jt = function (e, t, n) {
        if (e.src) {
          ...
          e.placeholder &&
            !e.loaded &&
            ((e.placeholder.style.width = o + 'px'), (e.placeholder.style.height = i + 'px')),
            (t.style.width = o + 'px'),
            (t.style.height = i + 'px');
        }
      },
      $t = function () {
        if (Wt.length) {
          for (var e, t = 0; t < Wt.length; t++)
            (e = Wt[t]).holder.index === e.index && qt(e.index, e.item, e.baseDiv, e.img, 0, e.clearPlaceholder);
          Wt = [];
        }
      };
    be('Controller', {
      publicMethods: {
        ...
        setContent: function (e, t) {
          ...
          if (s) {
            ...
            if (
              (!s.src && s.html && (s.html.tagName ? u.appendChild(s.html) : (u.innerHTML = s.html)),
              Xt(s),
              Yt(s, pe),
              ...
              s.src &&
                !s.loadError &&
                (((o = i.createEl('pswp__img', 'img')).style.opacity = 1), (o.src = s.src), jt(s, o), qt(0, s, u, o));
            else {
              if (
              ...
              s.loading || Vt(s),
                a.allowProgressiveImg() &&
                  (!zt && Z.transform
                    ? Wt.push({ item: s, baseDiv: u, img: s.img, index: t, holder: e })
                    : qt(0, s, u, s.img, 0, !0));
            }
              ...
              return (
                r.modal &&
                  (!r.closeOnScroll || Ye || G
                    ? e.preventDefault()
                    : D && Math.abs(e.deltaY) > 2 && ((u = !0), a.close())),
                !0
              );
    ...
    var nn,
      ...
      wn = function () {
        if ((an && clearTimeout(an), Ye || G)) an = setTimeout(wn, 500);
          ...
          fn
            ? '#' + n !== window.location.hash && history[cn ? 'replaceState' : 'pushState']('', document.title, o)
            : cn
            ? mn.replace(o)
            : (mn.hash = n),
            (cn = !0),
    ...
    return function (e, t) {
      var n,
        ...
        E = function (e) {
          ...
          for (var n, o, i = (e.target || e.srcElement).getAttribute('class') || '', a = 0; a < N.length; a++)
            (n = N[a]).onTap && i.indexOf('pswp__' + n.name) > -1 && (n.onTap(), (o = !0));
          if (o) {
        ...
        t.extend(e.options, I, !0),
          ...
          d('preventDragEvent', function (e, t, n) {
            ...
            o &&
              ...
              (o.getAttribute('class').indexOf('__caption') > 0 || /(SMALL|STRONG|EM)/i.test(o.tagName)) &&
              (n.prevent = !1);
          }),
              ...
              clearTimeout(f),
                (f = setTimeout(function () {
                  e.currItem && e.currItem.loading
                    ? (!e.allowProgressiveImg() || (e.currItem.img && !e.currItem.img.naturalWidth)) && Z(!1)
                    : Z(!0);
        ...
        (x.update = function () {
          C && e.currItem
            ? (x.updateIndexIndicator(),
              v.captionEl && (v.addCaptionHTMLFn(e.currItem, i), S(i, 'caption--empty', !e.currItem.title)),
              (b = !0))
            : (b = !1),
            T || M(),
            D();
  ...
  (function (e) {
    ...
    function r(r) {
      ...
      n.find('.pswp__sr4').remove(),
        sr4ThemeSP.$appendComponent.after(o),
        isThemeRTL && ((u = s - u - 1), (l = l.reverse()));
      var p = document.querySelectorAll('.pswp__sr4')[0],
        m = e('.' + i),
      ...
      if (
        ...
        f.listen('close', function () {
          if (c.hasClass('flickitysr4-enabled')) {
            if (isThemeRTL) var e = s - f.getCurrentIndex();
            else e = f.getCurrentIndex();
            c.flickitysr4('selectCell', e, !1, !0);
          }
        }),
        r.HasThumb)
      ) {
    ...
    (sr4ThemeSP.GalleryPhotoSwipe = function () {
      var t = !1;
      e('[data-sr4-gallery].flickitysr4-enabled').on('dragEnd.flickitysr4', function (e, n) {
        t = !0;
      }),
        e(document).on('click', '[data-sr4-gallery--open]', function (o) {
          o.preventDefault();
          var i = e(this),
            a = i.parents('[data-sr4-gallery--item]'),
            l = i.closest('[data-sr4-gallery]'),
            s = l.find('[data-pswp-src]');
          if (0 == s.length || t) t = !1;
          else {
            var u = l.is('[data-sr4-thumb-true]');
            r({
              index: a.index(),
              items: n(s),
              HasThumb: u,
              galleryItems: l,
              parents: '[data-sr4-gallery--item]',
              global: !1,
      ...
      var n = function (t) {
        ...
        return (
          t.each(function () {
            n.push({
              src: e(this).attr('data-pswp-src'),
              w: e(this).attr('data-pswp-w'),
              h: e(this).attr('data-pswp-h'),
            });
          }),
          n
        );
      ...
      (sr4ThemeSP.videoPoster = function () {
  ...
  jQuery_T4NT(document).ready(function (e) {
    sr4ThemeSP.GalleryPhotoSwipe(), sr4ThemeSP.videoPoster();
  });
