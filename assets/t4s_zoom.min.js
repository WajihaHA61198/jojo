(function (t) {
    ...
    (o.prototype._buildClasses = function (t) {
      ...
      (o.prototype.setPosition = function (t, e, i) {
        ...
        (t = i.left + t * i.width - this.el.clientWidth / 2 + n),
          ...
          t < i.left + n
            ? (t = i.left + n)
            : t + this.el.clientWidth > i.left + i.width + n && (t = i.left + i.width - this.el.clientWidth + n),
          e < i.top + s
            ? (e = i.top + s)
            : e + this.el.clientHeight > i.top + i.height + s && (e = i.top + i.height - this.el.clientHeight + s),
      ...
      (h.prototype._bindEvents = function () {
        ...
        this.settings.handleTouch
          ? (this.settings.el.addEventListener('touchstart', this._handleEntry, t),
            this.settings.el.addEventListener('touchend', this._hide, !1),
            this.settings.el.addEventListener('touchmove', this._handleMovement, t))
          : (this.settings.el.addEventListener('touchstart', this._preventDefault, t),
            this.settings.el.addEventListener('touchend', this._preventDefault, !1),
            this.settings.el.addEventListener('touchmove', this._preventDefault, t));
      }),
      ...
      (h.prototype._show = function () {
        if (this.enabled) {
          ...
          t && 'function' == typeof t && t(),
            ...
            this._lastMovement &&
              (((t = this._lastMovement.touches) && this.settings.touchBoundingBox) ||
      ...
      (h.prototype._handleMovement = function (t) {
        ...
        (e = (e - (t = this.settings.el.getBoundingClientRect()).left) / this.settings.el.clientWidth),
      ...
      (a.prototype.setPosition = function (t, e, i) {
        ...
        (s = c ? r / 2 : 0),
          ...
          this.el.parentElement === this.settings.inlineContainer &&
            ...
            (t = i.left + t * i.width - o / 2 + this.settings.inlineOffsetX + u),
            (e = i.top + e * i.height - h / 2 + this.settings.inlineOffsetY + c),
            this.settings.containInline &&
              (t < i.left + u ? (t = i.left + u) : t + o > i.left + i.width + u && (t = i.left + i.width - o + u),
              e < i.top + c ? (e = i.top + c) : e + h > i.top + i.height + c && (e = i.top + i.height - h + c)),
            (this.el.style.left = t + 'px'),
            (this.el.style.top = e + 'px')),
          this.settings.showWhitespaceAtEdges ||
            (a > s ? (a = s) : a < r && (a = r), l > n ? (l = n) : l < d && (l = d)),
  ...
  (function (t) {
    ...
    var e = t(window).width(),
      i = t('html');
    sr4ThemeSP.ProductZoom = (function () {
      var n = { fade_media: 'zoom_fade_media', fade_infor: 'zoom_fade_info', enabled: 'is-zoom-enabled' },
        s = 'is--zoom_tp_';
      function o(e) {
        var o,
          h = ((o = e.attr('data-zoom-options')), JSON.parse(o || '{}')),
          a = e.find('[data-sr4-zoom-media]'),
          l = e.find('[data-sr4-zoom-info]'),
          r = h.isZoomPR ? e.find('[data-media-type="image"] [data-master]') : e.find('[data-zoom-target]'),
          d = l.find('.sr4-product__zoom-wrapper')[0],
          c = h.type,
          u = h.magnify,
          p = (h.touch, h.pr_type),
          m = 'external' == c;
        e.addClass(s + c),
          '2' == c && p && ((c = '1'), i.removeClass(s + 'external').addClass(s + 'inner')),
          r.each(function () {
            var e = t(this),
              i = e[0];
      ...
      return function () {
        var i = t('[data-sr4-zoom-main]:not(.' + n.enabled + ')');
        0 == i.length ||
          e < 1025 ||
