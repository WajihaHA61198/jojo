...
// C.$mobileNav.on('click', '.sr4-item-level-0', function (n) {
//   alert('hj');
//   n.preventDefault();
//   n.stopPropagation();
//   $('.sr4-item-level-0').not(this).each(function () {
//     $(this).removeClass('is--opend');
//     const submenu = $(this).find('.sr4-sub-menu');
//     if (submenu.length) submenu.hide();
//   });
// });

// C.$mobileNav.on('click', '.sr4-item-level-1', function (n) {
//   n.preventDefault();
//   n.stopPropagation();
//   $('.sr4-item-level-1').not(this).each(function () {
//     $(this).removeClass('is--opend');
//     const submenu = $(this).find('.sr4-sub-sub-menu');
//     if (submenu.length) submenu.hide();
//   });
// });
        }
