!(function (e) {
  ...
  (e.ThreeSixty = function (t, r) {
    ...
    (n.$el = e(t)),
      ...
      (n.init = function () {
        (a = e.extend({}, e.ThreeSixty.defaultOptions, r)).disableSpin && ((a.currentFrame = 1), (a.endFrame = 1)),
          n.initProgress(),
          n.loadImages();
      }),
      (n.resize = function () {}),
      (n.initProgress = function () {
        n.$el.css({ width: a.width + 'px', height: a.height + 'px', 'background-image': 'none !important' }),
      ...
      (n.loadImages = function () {
        ...
        (t = document.createElement('li')),
          ...
          (i = e('<img>').attr('src', r).addClass('previous-image').appendTo(t)),
          o.push(i),
      ...
      (n.imageLoaded = function () {
        (a.loadedImages += 1),
          e(a.progress + ' span').text(Math.floor((a.loadedImages / a.totalFrames) * 100) + '%'),
          a.loadedImages >= a.totalFrames
            ? (a.disableSpin && o[0].removeClass('previous-image').addClass('current-image'),
      ...
      (n.play_stop = function (t) {
        t.preventDefault(),
          a.autoplay
            ? ((a.autoplay = !1),
              e(t.currentTarget).removeClass('nav_bar_stop').addClass('nav_bar_play'),
              clearInterval(a.play),
              (a.play = null))
            : ((a.autoplay = !0),
              (a.play = setInterval(n.moveToNextFrame, a.playSpeed)),
              e(t.currentTarget).removeClass('nav_bar_play').addClass('nav_bar_stop'));
      }),
      (n.next = function (e) {
      ...
      (n.play = function (e, t) {
        ...
        (a.autoplayDirection = o), a.autoplay || ((a.autoplay = !0), (a.play = setInterval(n.moveToNextFrame, r)));
      }),
      (n.stop = function () {
        ...
        n.$el.bind('mousedown touchstart touchmove touchend mousemove click', function (e) {
          e.preventDefault(),
            ('mousedown' === e.type && 1 === e.which) || 'touchstart' === e.type
              ? ((a.pointerStartPosX = n.getPointerEvent(e).pageX), (a.dragging = !0), a.onDragStart(a.currentFrame))
              : 'touchmove' === e.type
              ? n.trackPointer(e)
          ...
          e(document).bind('mousemove', function (e) {
            a.dragging
              ? (e.preventDefault(),
                !n.browser.isIE && a.showCursor && n.$el.css('cursor', 'url(assets/images/hand_closed.png), auto'))
              : !n.browser.isIE && a.showCursor && n.$el.css('cursor', 'url(assets/images/hand_open.png), auto'),
              n.trackPointer(e);
          }),
        ...
        a.ready &&
          ...
          a.monitorStartTime < new Date().getTime() - a.monitorInt &&
            ...
            a.pointerDistance > 0
              ? (a.endFrame =
                  a.currentFrame +
                  Math.ceil((a.totalFrames - 1) * a.speedMultiplier * (a.pointerDistance / n.$el.width())))
              : (a.endFrame =
                  a.currentFrame +
                  Math.floor((a.totalFrames - 1) * a.speedMultiplier * (a.pointerDistance / n.$el.width()))),
            a.disableWrap &&
              ((a.endFrame = Math.min(a.totalFrames - (a.zeroBased ? 1 : 0), a.endFrame)),
      ...
      (n.render = function () {
        ...
        a.currentFrame !== a.endFrame
          ? ((e =
            ...
            (a.currentFrame += e),
            n.showCurrentFrame(),
            n.$el.trigger('frameIndexChanged', [n.getNormalizedCurrentFrame(), a.totalFrames]))
      ...
      (n.getNormalizedCurrentFrame = function () {
        ...
        return (
          a.disableWrap
            ? ((e = Math.min(a.currentFrame, a.totalFrames - (a.zeroBased ? 1 : 0))),
              (t = Math.min(a.endFrame, a.totalFrames - (a.zeroBased ? 1 : 0))),
              (e = Math.max(e, a.zeroBased ? 0 : 1)),
              (t = Math.max(t, a.zeroBased ? 0 : 1)),
              (a.currentFrame = e),
              (a.endFrame = t))
            : 0 > (e = Math.ceil(a.currentFrame % a.totalFrames)) && (e += a.totalFrames - (a.zeroBased ? 1 : 0)),
          e
        );
      }),
      ...
      (n.responsive = function () {
        a.responsive && n.$el.css({ height: n.$el.find('.current-image').first().css('height'), width: '100%' });
      }),
